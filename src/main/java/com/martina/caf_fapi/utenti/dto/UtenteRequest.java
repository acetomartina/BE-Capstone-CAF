...
public class UtenteRequest {
    ...
    @Size(max = 100, message = "Il comune non può superare i 100 caratteri.")
    private String comune;

    @Pattern(
            regexp = "^$|^[A-Za-z]{2}$",
            message = "La provincia deve essere composta da due lettere."
    )
    ...
    @Size(min = 8, max = 100, message = "La password deve contenere tra 8 e 100 caratteri.")
    private String password;

    @Size(max = 100, message = "La mansione non può superare i 100 caratteri.")
    private String mansione;

    @Size(max = 50, message = "Il numero di matricola non può superare i 50 caratteri.")
